...
namespace OrdersReport
{
    public class OrdersReportTests
    {
        ...
        public void should_calculate_total_sales_within_range()
        {
            ...
            var result = new After.OrdersReport().Handle(
                new(
                    orders,
                    After.DateRange.Between("10/1/2022", "10/2/2022")
                    ));
        ...
        public void should_calculate_total_sales_within_range_for_initial_code()
        {
            ...
            var orderReport = new Before.OrdersReport(orders, DateTime.Parse("10/1/2022"), DateTime.Parse("10/2/2022"));
